return {
  ...
  ["workshop-687193679"]={
    configuration_options={ twigs_to_create=10, twigs_to_create_a_log=10 },
    enabled=true 
  },
  ["workshop-726432903"]={
    configuration_options={
      Connections={ ["1"]={ "11", "12" }, ["11"]={ "12" } },
      DeleteUnused=1,
      EnableStartingItems=0,
      MultiConnections={  },
      SynchronizeSeasons=1,
      UseDefaultLocations=1,
      UseMigrationPortals=0,
      UseMultiShards=0,
      WorldNames={  } 
    },
    enabled=true 
